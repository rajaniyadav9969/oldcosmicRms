...
import { GetSegmentHistory_API, SegmentUpdate_API } from '../../Redux/API';
...
const SegmentHistory = (props) => {
    ...
    const handleShow = async (e) => {
        e.preventDefault()
        setNotifyData((data) => ({ ...data, loadingFlag: true, loadingMsg: "Retriving segment history data..." }))
        const ps1 = new Promise((resolve, reject) => {
            resolve(GetSegmentHistory_API())
        })
    ...
    const handleUpdate = async (e) => {
        ...
        const ps1 = new Promise((resolve, reject) => {
            resolve(SegmentUpdate_API(updatedData))
        })
        const rs = await Promise.all([ps1]).then((val) => {
            return val[0]['data'];
        }).catch((err) => {
                        ...
                        <input
                            ...
                            onClick={(e) => {
                                ...
                                setNotifyData((data) => ({
                                    ...data,
                                    confirmFlag: true,
                                    confirmMsg: "Are you sure, You want to update segment history name?",
                                    confirmAction: (e) =>
                                        handleUpdate(e)
                                }))
                            }}
...
export default memo(SegmentHistory)