...
import { GetExcludeUserIdHis_API } from '../../Redux/API';
                ...
                <Row className={profile.historySection}>
                    ...
                    <div className='col-md-1'>
                        <input
                            ...
                            onClick={async (e) => {
                                e.preventDefault()
                                setNotifyData((data) => ({ ...data, loadingFlag: true, loadingMsg: "Retriving exclude userid history data..." }))

                                const ps1 = new Promise((resolve, reject) => {
                                    resolve(GetExcludeUserIdHis_API())
                                })
...
export default memo(UserIdExcludeHis)