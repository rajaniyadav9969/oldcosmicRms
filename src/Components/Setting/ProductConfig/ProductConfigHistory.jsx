...
import { GetProductConfHis_API } from '../../Redux/API';
                ...
                <Row className={profile.historySection}>
                    ...
                    <div className='col-md-1'>
                        <input
                            ...
                            onClick={async (e) => {
                                e.preventDefault()
                                setNotifyData((data) => ({ ...data, loadingFlag: true.valueOf, loadingMsg: "Retriving product connfiguration history data..." }))
                                const ps1 = new Promise((resolve, reject) => {
                                    resolve(GetProductConfHis_API('show'))
                                })
...
export default memo(ProductConfigHistory)