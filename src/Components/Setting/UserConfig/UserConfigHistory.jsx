...
import { UserConfigHistory_API } from '../../Redux/API';
                ...
                <Row className={profile.historySection}>
                    ...
                    <div className='col-md-1'>
                        <input
                            ...
                            onClick={async (e) => {
                                e.preventDefault()
                                setNotifyData((data) => ({ ...data, loadingFlag: true, loadingMsg: "Retriving user configuration history data..." }))
                                const ps1 = new Promise((resolve, reject) => {
                                    resolve(UserConfigHistory_API({ date: dateValue, exchange: exchange }))
                                })
...
export default memo(UserConfigHistory)